            ...
            steps {
                script {
                    ...
                    withCredentials([string(credentialsId: 'dependency-track-token', variable: 'API_KEY')]) {
                        dependencyTrackPublisher artifact: 'target/bom.xml', projectName: 'ci-integrated', projectVersion: '1.1.1', synchronous: true, dependencyTrackApiKey: API_KEY, projectProperties: [tags: ['tag1', 'tag2'], swidTagId: 'my swid tag', group: 'my group']
                    }
                }//script
            }//steps
        }//stage
